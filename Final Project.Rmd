...
Both backward and forward selection showed that the lowest AIC value kept all covariates in the model. Therefore, we will keep all covariates in the model! 
...
From our final model, we can see that each covariate is statistically significant. This is further validated through the high values of R^2 and adjusted R\^2.
